...
(function () {
    ...
    var loadChat = function (cb) {
        ...
        $.get("https://rawgit.com/spacesven/basicBot/master/lang/langIndex.json", function (json) {
    ...
    var basicBot = {
        ...
        settings: {
            ...
            motdEnabled: true,
            motdInterval: 12,
            motd: "enter !commands for all our bot-commands",
            filterChat: true,
            ...
            blacklists: {
                ...
                OP: "https://rawgit.com/spacesven/basicBot-customization/master/blacklists/ExampleOPlist.json"
            }
        },
        room: {
            users: [],
